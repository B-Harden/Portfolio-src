...
@app.route('/first')
def first():
    # text_1 = db.execute('SELECT * FROM text WHERE id= 7').fetchone()
    # return text_1.text
    return texts[0]

@app.route('/second')
def second():
    # text_2 = db.execute('SELECT * FROM text WHERE id= 8').fetchone()
    # return text_2.text
    return texts[1]

@app.route('/third')
def third():
    # text_3 = db.execute('SELECT * FROM text WHERE id= 9').fetchone()
    # return text_3.text
    return texts[2]